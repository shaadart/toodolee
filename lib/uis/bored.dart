...
//           var showBoredCard = bored.get("showBoredCard", defaultValue: false);

//           if (bored.get("showBoredCard") == true || completedBox.length >= 3) {
//             bored.put("showBoredCard", true);
//             if (bored.isEmpty || bored.get("thirdCard") == null) {
//               getBoringData();
//               return Shimmer(
...
//                   title: Padding(
//                     padding:
//                         EdgeInsets.all(MediaQuery.of(context).size.shortestSide / 20),
...
//               ]));
//             }
//             //else if (bored.get("showBoredCard") == true) {
//             else {
